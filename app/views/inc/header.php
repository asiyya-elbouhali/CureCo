...
<head>
    ...
    <title>CureCo</title>
    <link rel="shortcut icon" href="<?php URLROOT?>/css/style.css" type="image/x-icon">
 
    <link rel="shortcut icon" href="../img/favicon_Cureco.png" type="image/x-icon">
...
<!-- <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
    ...
    <link rel="stylesheet" href="<?= URLROOT;?>/css/tooplate.css">
